...
const emailRules = [
  ...
  value => /^[a-zA-Z0-9@._-]+$/.test(value) || 'E-mail must not contain special characters',
]
            ...
            <v-row>
                <v-col cols="12" md="6" class="justify-center align-center d-none d-md-block">
                    <div class="d-flex justify-center align-center">
                        <img src="~/assets/img/login.svg" alt="Regist illustration" style="max-width: 100%;" />
                    </div>
                </v-col>
                ...
                <v-col cols="12" md="6" class="py-0 d-flex justify-center align-center">
                    <v-hover v-slot="{ isHovering, props }">
                        ...
                        >
                            <v-card-title class="text-h5 text-wrap pa-0 font-weight-bold">Create new account</v-card-title>
                            <v-card-title class="text-h6 text-wrap mb-3 pa-0">Please enter your details to create a new account</v-card-title>
                            <v-form v-model="form" @submit.prevent="register">
                                <v-text-field variant="outlined" v-model="name" label="Name" :rules="nameRules"></v-text-field>
                                <v-text-field variant="outlined" v-model="email" label="Email" :rules="emailRules"></v-text-field>
